 ...
 * 
 * @author yang
 * @date 2018年4月8日 下午4:23:33
 * @since 1.0
 */
public class TestOffice2PDF {
	...
	/**
	 * 下载 :http://sourceforge.net/projects/jacob-project/files/
	 * 
	 * 解压后获得3个文件 jacob.jar jacob-1.17-x64.dll jacob-1.17-x86.dll
	 * 
	 * jacob.jar 放到项目的lib目录 jacob-1.17-x64.dll 放到C:\Windows\System32
	 * jacob-1.17-x86.dll 放到C:\Windows\SysWOW64
	 * 
	 * @param args
	 * @author yang
	 * @date 2018年4月8日 下午5:03:07
	 */
	public static void main(String[] args) {
		// System.out.println(System.getProperty("java.library.path"));
		// int time = convert2PDF("D:\\Test\\02设计院电子图纸系统需求规格说明书.docx",
		// "D:\\Test\\02设计院电子图纸系统需求规格说明书.pdf");
		int time = convert2PDF("D:\\Test\\3.广东省人大电子档案系统项目计划-研发二部.xlsx", "D:\\Test\\3.广东省人大电子档案系统项目计划-研发二部.pdf");

		if (time == -4) {
			System.out.println("转化失败:==-4，未知错误...");
		} else if (time == -3) {
			System.out.println("原文件就是PDF文件,无需转化...");
		} else if (time == -2) {
			System.out.println("转化失败:==-2，文件不存在...");
		} else if (time == -1) {
			System.out.println("转化失败:==-1，请重新尝试...");
		} else if (time < -4) {
			System.out.println("转化失败:<-4，请重新尝试...");
		} else {
